...
export function PreviewPanel() {
  ...
  const sendToPreview = () => {
    ...
    if (iframe?.contentWindow && previewReady) {
      ...
      const { themeId, paletteId, colors, fonts, style, background, cardTypeFontSizes, socialIconSize, vcrCenterContent, receiptPrice, receiptStickers, receiptFloatAnimation, ipodStickers, ipodTexture } = useThemeStore.getState()
      const themeSnapshot = { themeId, paletteId, colors, fonts, style, background, cardTypeFontSizes, socialIconSize, vcrCenterContent, receiptPrice, receiptStickers, receiptFloatAnimation, ipodStickers, ipodTexture }
