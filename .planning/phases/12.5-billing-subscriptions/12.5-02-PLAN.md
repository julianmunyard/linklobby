...
- If on a paid plan: "Your {Pro/Artist} plan renews on {date}" or "Your plan ends on {date}" if canceling
- "Upgrade Plan" button (links to /pricing) if on Free
- "Manage Billing" button that creates a Stripe Customer Portal session:
  ```typescript
